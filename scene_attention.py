...
def main():
    ...
    atten_1 = attention.atten_module(128).to(opt.device)
    atten_2 = attention.atten_module(256).to(opt.device)
    atten_3 = attention.atten_module(512).to(opt.device)
    optimizer_a1 = optim.SGD(atten_1.parameters(), lr=opt.lr, momentum=0.9, nesterov=opt.nesterov)
    optimizer_a2 = optim.SGD(atten_2.parameters(), lr=opt.lr, momentum=0.9, nesterov=opt.nesterov)
    optimizer_a3 = optim.SGD(atten_3.parameters(), lr=opt.lr, momentum=0.9, nesterov=opt.nesterov)
    ...
    data_test_loader_1 = DataLoader(data_test_1, batch_size=100, num_workers=8)
    data_test_2 = polaroid.Polaroid(opt.scene + "factory2", train=False, transform=transform_test)
    data_test_loader_2 = DataLoader(data_test_2, batch_size=100, num_workers=8)
    data_test_3 = polaroid.Polaroid(opt.scene + "factory3", train=False, transform=transform_test)
    data_test_loader_3 = DataLoader(data_test_3, batch_size=100, num_workers=8)
    ...
    data_train_loader_1 = DataLoader(data_train_1, batch_size=40, num_workers=8, shuffle=True)
    data_train_2 = polaroid.Polaroid(opt.scene + "factory2", train=True, transform=transform_test)
    data_train_loader_2 = DataLoader(data_train_2, batch_size=40, num_workers=8, shuffle=True)
    data_train_3 = polaroid.Polaroid(opt.scene + "factory3", train=True, transform=transform_test)
    data_train_loader_3 = DataLoader(data_train_3, batch_size=40, num_workers=8, shuffle=True)
    ...
    for i in range(opt.n_epochs):
        ...
        for j in range(opt.iteration):
            ...
            f_1 = atten_1(f_t1[0], f_t2[0], f_t3[0])
            f_2 = atten_2(f_t1[1], f_t2[1], f_t3[1])
            f_3 = atten_3(f_t1[2], f_t2[2], f_t3[2])
