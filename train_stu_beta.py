    ...
    for i in range(opt.n_epochs):
        ...
        for j in range(40):
            ...
            if i < 10:
                ...
                # model.conv2a.weight = nn.Parameter(best_teacher_model1.conv2a.weight.clone()).cuda()
                # model.conv3a.weight = nn.Parameter(best_teacher_model2.conv3a.weight.clone()).cuda()
                # model.conv3b.weight = nn.Parameter(best_teacher_model3.conv3b.weight.clone()).cuda()
                if i==0&j==0:
                    model.conv2a.weight = best_teacher_model1.conv2a.weight.clone()
                    model.conv3a.weight = best_teacher_model2.conv3a.weight.clone()
                    model.conv3b.weight = best_teacher_model3.conv3b.weight.clone()
